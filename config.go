...
func init() {
	...
	flag.StringVar(&config.NacosUsername, "NacosUsername", "", "nacos username (only used with nacos backends)")
	flag.StringVar(&config.NacosPassword, "NacosPassword", "", "nacos password (enable watch support)")
}
